export const DOMElements = {
    ...
    selectBlockReward:      document.getElementById('selectBlockReward'),

    selectNetworkPower:     document.getElementById("selectNetworkPower"),
    inputNetworkPower:      document.getElementById("inputNetworkPower"),

    selectUserPower:        document.getElementById("selectUserPower"),
    inputUserPower:         document.getElementById("inputUserPower"),
